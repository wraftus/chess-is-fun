...
if __name__ == "__main__":
    ...
    train_dataset = ChessDataset(args.create_train, True, 50000)
    val_dataset = ChessDataset(args.create_val, False, 1000000)
    ...
    train_dataset = train_dataset.shuffle(100).batch(256)
